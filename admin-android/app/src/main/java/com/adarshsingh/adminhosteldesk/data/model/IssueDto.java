...
public class IssueDto {
    ...
    @SerializedName("wardenViewCount")
    private Long wardenViewCount;

    @SerializedName("wardenViewedAt")
    private String wardenViewedAt;
    ...
    public Long getWardenViewCount() { return wardenViewCount; }
    public void setWardenViewCount(Long wardenViewCount) { this.wardenViewCount = wardenViewCount; }

    public String getWardenViewedAt() { return wardenViewedAt; }
    public void setWardenViewedAt(String wardenViewedAt) { this.wardenViewedAt = wardenViewedAt; }
