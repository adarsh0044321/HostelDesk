...
import com.adarshsingh.hosteldesk.data.model.ActivityDto;
import com.adarshsingh.hosteldesk.databinding.ItemActivityTimelineBinding;
            ...
            switch (action.toUpperCase()) {
                ...
                case "ASSIGNED":
                    if (activity != null && activity.getActorRole() != null) {
                        ...
                        if (role.contains("INSTITUTE_ADMIN") || role.contains("SUPER_ADMIN") || role.equals("ADMIN")) {
